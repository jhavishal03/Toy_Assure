...
public class BinController {
    ...
    public ResponseEntity<Response> addBins(@RequestParam Long numBin) {
        List<Long> res = binDto.addBinsToSystem(numBin);
        return new ResponseEntity(new Response<>("Bins Added Successfully with BinPojo Ids-> ", res), HttpStatus.CREATED);
    }
    
    @ApiOperation(value = "This Api is used to update quantity of product in a BinPojo")
    ...
    public ResponseEntity<Response> uploadBinWiseInventory(@PathVariable("client-Id") Long clientId,
        ...
        List<BinSkuPojo> updatedData = binDto.uploadBinData(clientId, file);
